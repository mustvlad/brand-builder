...
export const getDistinctiveElementsTemplate = `Q: Clasifica informatiile primite ca input si extrage o lista de elemente diferentiatoare ale unui nutritionist dietetician raportate la media de piata din Romania.
...
export const getBrandStatementTemplate = `Q: Plecand de la insight-ul de mai jos, scrie un brand statement despre nutritionist-dieteticianul {fullName}.
...
export const getHowTemplate = `Q: Extrage din urmatoarele elementele diferentiatoare ale {fullName} un paradox / intriga despre acest nutritionist-dietetician pe care-l putem folosi ca beneficiu pentru pacient dar si pentru a-l pune intr-o lumina buna.  

Reguli: Paradoxul trebuie sa sublinieze metoda sau modul diferentiator al nutritionist-dieteticianului de a rezolva problemele pacientilor.

Elemente diferentiatoare: {distinctiveElements}

A:`;

export const getWhatTemplate = `Q: Pornind de la input, extrage o lista de servicii pe care pacientii le pot obtine de la nutritionist-dieteticianul {fullName}.
...
export const getWhyTemplate = `Pe principiul cartii "Start with WHY" pacientii se conecteaza la brand-ul unui nutritionist-dietetician nu pentru ceea ce face el ci pentru motivul care sta la baza misiunii lui personale.

Q: Pornind de la input, extrage intr-o fraza simpla care este WHY-ul care sta in spatele misiunii nutritionist-dieteticianului {fullName}? Incepe direct cu "Misiunea lui este ..."
...
export const generateContentPillarsTemplate = `Q: Pornind de la urmatoarele informatii despre nutritionist dietetician-ul {fullName}, genereaza 3 piloni de continut pentru social media pe baza carora sa-si construiasca strategia editoriala din online.
